...
Treat the history as having a shape: how it began and broke the ice; how it mutated (topics, frequency, initiation, intimacy); and whether and where it cooled (slower replies, who stopped initiating). Anchor each phase to dated messages.
